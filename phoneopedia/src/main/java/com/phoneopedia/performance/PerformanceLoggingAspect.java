package com.phoneopedia.performance;
...
public class PerformanceLoggingAspect {
  ...
  @Around("execution(* com.phoneopedia.service..*(..))|| "
      + "execution(* com.phoneopedia.logic..*(..)) || "
      + "execution(* com.phoneopedia.dataaccess..*(..)) || "
      + "execution(* com.phoneopedia.kafkamodule..*(..)) || "
      + "execution(* com.phoneopedia.logging..*(..))")
