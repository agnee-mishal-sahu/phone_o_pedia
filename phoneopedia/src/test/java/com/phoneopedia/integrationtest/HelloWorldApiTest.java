package com.phoneopedia.integrationtest;
...
import com.phoneopedia.Application;
import com.phoneopedia.commons.Resources;
import com.phoneopedia.config.EmbeddedDataSourceInstance;
import com.phoneopedia.security.filters.JWTAuthorizationFilter;
...
@ActiveProfiles("test")
@ContextConfiguration(classes = Application.class, initializers = EmbeddedDataSourceInstance.class)
@SpringBootTest()
